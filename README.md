...
<table width="100%">
  <tr>
    <td width="30%"><b>Mathematical Physics</b></td>
    <td>Symbolic Tensor Calculus (SymPy / Tensor Algebra), Black Hole Perturbation Theory, Numerical ODE/PDE Integration</td>
  </tr>
  <tr>
    <td width="30%"><b>AI & Narrative Architecture</b></td>
    <td>Generative Agents (Decide-Enact-Reflect), Knowledge-Gated Memory, Voiceprint Alignment, State Machines</td>
  </tr>
  <tr>
    <td width="30%"><b>System Engineering</b></td>
    <td>SQLite Single-Source Truth DB, Design-by-Contract Compilers, Physical Invariants Verification, Python 3.10+</td>
  </tr>
</table>
